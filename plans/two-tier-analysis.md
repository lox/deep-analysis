...
Goal: cut cost/latency while keeping quality by having GPT-5-Pro focus on reasoning while GPT-5.1 handles mechanical file operations.
...
2. **Cost efficient**: GPT-5-Pro tokens spent on reasoning, not parsing file listings
3. **Iterative**: Researcher can refine searches based on what it learns
4. **Clear separation**: GPT-5-Pro = strategy/reasoning, GPT-5.1 = navigation/mechanics
